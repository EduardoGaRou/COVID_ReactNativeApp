...
const SummonRecoverd = () => {
    return(
        <Text>This is a Summon</Text>
    );
};

const SummonRecovered = ({route,navigation}) => {
        ...
        <View style={styles.page}>
            ...
            <View style={styles.section}>
                <Animated.View
                    ...
                    <Text style={styles.info}>Recovered: {recovered}</Text>
                </Animated.View>
            </View>
            <View style={styles.section}>
                <Animated.View
            ...
            <View style={{flex: 1, paddingHorizontal: 15}}>
                <TouchableHighlight
                    ...
                    onPress={() => navigation.navigate("Recovered")}>
...
export default SummonRecovered;